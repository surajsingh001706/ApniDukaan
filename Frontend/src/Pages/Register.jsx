    ...
    return (
           <div className='flex'>
               <div className='w-full md:w-1/2 flex flex-col justify-center items-center p-8'>
                   <form onSubmit={handleSubmit}className='w-full max-w-md bg-white p-8 rounded-lg border-2 border-black shadow-sm ' action="">
                       <div className='flex justify-center mb-6'>
                           <h2 className='text-xl font-medium'>ApniDukaan</h2>
                       </div>
                       <h2 className='text-2xl font-bold text-center mb-6'>Hey there! 👋
                       </h2>
                       ...
                       transition'>{loading ?"Loading...":"Sign Up"}</button>
