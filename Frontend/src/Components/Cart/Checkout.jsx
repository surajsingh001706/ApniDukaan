...
const Checkout = () => {
    ...
    const [shippingAddress, setShippingAddress] = useState({
        ...
        email: "",            // Optional - for contact or confirmation
        phone: "",            // Contact number (very important for delivery)
        address: "",     // Main address line (e.g., house number, street
        city: "",             // City
        state: "",            // State or province
        postalCode: "",       // ZIP or PIN code
        country: "",          // Country (use dropdown/select for standardization)
    });
    ...
    return (
        <div className='grid grid-cols-1 lg:grid-cols-2 max-w-7xl mx-auto py-10 px-10 tracking-tighter gap-4'>
            {/* Left Section */}
            ...
            <div className='bg-gray-50 p-6 rounded-lg border'>
                <h3 className='text-2xl mb-4 font-bold'>Order Summary</h3>
